...
@WebServlet(name = "admin_goods_list",urlPatterns = "/supreme_admin/goods_list")
public class AdminGoodsListServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/supreme_admin/goods_list.jsp").forward(request, response);
    }
