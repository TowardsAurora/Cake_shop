...
@WebServlet(name = "admin_goods_recommend",urlPatterns = "/supreme_admin/goods_recommend")
public class AdminGoodsRecommendServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/supreme_admin/goods_list").forward(request, response);
    }
