...
<div class="cart-items">
    <div class="container">
        ...
        <form class="form-horizontal" action="/order_confirm" method="post" id="payform">
            ...
            <div class="row">
                <label class="control-label col-md-1">收货人电话</label>
                <div class="col-md-6">
                    <input type="text" class="form-control" name="phone" value="${user.phone }" style="height:auto;padding:10px;" placeholder="输入收货人电话：" required="required"><br>
                </div>
            </div>
            <div class="row">
