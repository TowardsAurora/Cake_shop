        ...
        <nav class="navbar navbar-default" role="navigation">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="/goods_recommend_list.jsp?type=2" <c:if test="${param.flag==3 && t==2}">class="active"</c:if>>热销</a></li>
                    <li><a href="/goods_recommend_list.jsp?type=3" <c:if test="${param.flag==3 && t==3}">class="active"</c:if>>新品</a></li>
                    ...
                    <c:if test="${!empty user && user.isadmin }">
                        <li><a href="/supreme_admin/index.jsp" target="_blank">后台管理</a></li>
                    </c:if>
                </ul>
                <!--/.navbar-collapse-->
            </div>
